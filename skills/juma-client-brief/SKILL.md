...
See [clarifying-questions.md](clarifying-questions.md) for the complete question set organized by category (Background & Context, Objectives, Audience, Scope & Constraints, Budget & Timeline, Deliverables).

### Step 3: Map to SMART Objectives

Take the client's stated goals and convert each into SMART format. See [smart-objectives-framework.md](smart-objectives-framework.md) for the complete SMART criteria definitions and success criteria framework.
...
For each SMART objective, define measurable success criteria including primary KPI, baseline, target value, leading indicators, measurement cadence, and definition of failure. See [smart-objectives-framework.md](smart-objectives-framework.md) for the complete success criteria checklist.
