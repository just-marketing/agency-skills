# Clarifying Questions for Client Briefs

Compare the raw request against the brief template. Identify every gap and prepare targeted questions. Group questions logically and ask them in a single, organized message -- do not drip-feed questions across multiple exchanges.
